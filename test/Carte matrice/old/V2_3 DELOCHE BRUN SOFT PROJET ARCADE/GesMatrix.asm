...
;GesMatrix.c,281 :: 		pie2.TMR3IE = 0;
	BCF         PIE2+0, 1 
;GesMatrix.c,283 :: 		SaveVD = VoletDroit;     //volet droit et gauche sont ecrasé lors du
...
;GesMatrix.c,626 :: 		latd = TabMatrix[k];
	...
	MOVF        POSTINC0+0, 0 
	MOVWF       LATD+0 
;GesMatrix.c,627 :: 		portc.BIT_RW_MEM = 1;    //ack donnée
	BSF         PORTC+0, 5 
...
;GesMatrix.c,758 :: 		AppelImg.MajImg = FAUX;
	CLRF        _AppelImg+0 
;GesMatrix.c,759 :: 		AppelImg.ValPWM = 0;     //luminosité maxi
	CLRF        _AppelImg+5 
