...
//
//      PE : NumImg  : numero image [0..31]
//           ptImage : pointeur sur l'image  en RAM
//
//      PS : N/A
//
...
//
//  PE : NumImage     : numero d'image eeprom [0 .. 31]
//       ptImgage     : pointeur sur l'image
//
//  Variable globale:
...
//			 ptImgHte   : pointeur sur l'amege haute en RAM
//           ptImgBas   : pointeur sur l'image basse en RAM
//
//      PS :
//
...
//           ptAppelImg : pointeur sur la structure de gestion des images
//			 ptImgHte   : pointeur sur l'image haute en RAM
//           ptImgBas   : pointeur sur l'image basse en RAM
//
//      PS : N/A
//
